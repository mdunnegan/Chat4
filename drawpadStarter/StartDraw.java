...
import client.Chat4ClientCommandProcessor;
import drawpad.OpenDrawPad;
 ...
 * @version August 2001
 */
public class StartDraw extends Observable implements Observer
{
	
  private Chat4ClientCommandProcessor c4ccp;
  
  public StartDraw(Chat4ClientCommandProcessor c){
	  //this.oc = oc;
	  c4ccp = c;
  }
  ...
  public void update(Observable obs, Object obj)
  {
    ...
    if (msg.startsWith("#send"))
    {
      ...
      msg = msg.replace("w", "w ");
      //System.out.println("###msg###: " + msg); // need a space between #linedraw and the numbers 
      setChanged();
      c4ccp.handleMessageFromClientUI(msg.substring(6));
